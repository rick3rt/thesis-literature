...
% LOCATIONS TO IMAGE
Imaging can be done at three locations; Over the muscle belly to obtain fibre length of one or more muscles with similar function (e.g. \cite{klint_afferent_2009, cronin_triceps_2015}) 

Muscle tendon junction, fibre and tendon length (e.g. \cite{klint_afferent_2009})

Tendon to obtain tendon elongation 
...
% ===========================================================================
\subsection{Conventional imaging in reflex identification}
...
Instead, hypothesis established by [Lance and Degail, cite] that stretch reflex 
